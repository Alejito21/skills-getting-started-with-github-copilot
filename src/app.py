...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim workouts and lap practice for all levels",
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["zoe@mergington.edu", "max@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Math Olympiad": {
        ...
        "max_participants": 16,
        "participants": ["arjun@mergington.edu", "elena@mergington.edu"]
    },
    "Science Club": {
